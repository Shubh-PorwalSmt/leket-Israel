...
const MoreFilters = ({ cardText, imageStyle, handleClearFilters, optionArea, optionCareStatus, optionMoreFilters, setOptionArea, setOptionCareStatus, setOptionMoreFilters }) => {
    ...
    const displayAreaTag = <CardContent>
        <Box display="flex" flexDirection='row'>
            ...
            <div>
                <Typography component="div" variant="h6" fontSize={textSize} sx={cardText}>אזור</Typography>
                <Typography component="div" variant="h6" fontSize={textSize} fontWeight="bold" sx={cardText}>{optionArea}</Typography>
            </div>
        </Box>
    </CardContent>
    ...
    const displayCareStatusTag = <CardContent>
        <Box display="flex" flexDirection='row'>
            <KeyboardArrowDown style={{ color: "green" }} sx={imageStyle} />
            <div>
                <Typography component="div" variant="h6" fontSize={textSize} sx={cardText}>סטטוס טיפול</Typography>
                <Typography component="div" variant="h6" fontSize={textSize} fontWeight="bold" sx={cardText}>{optionCareStatus}</Typography>
            </div>
        </Box>
    </CardContent>
    ...
    const displayMoreFiltersTag = <CardContent>
        <Box display="flex" flexDirection='row'>
            <KeyboardArrowDown style={{ color: "green" }} sx={imageStyle} />
            <Typography component="div" variant="h6" fontSize={textSize} sx={cardText}>עוד מסננים</Typography>
            <Typography component="div" variant="h6" fontSize={textSize} fontWeight="bold" sx={cardText}>{optionMoreFilters}</Typography>
        </Box>
    </CardContent>
